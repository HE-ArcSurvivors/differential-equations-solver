...
public class Tank implements Iterable<Tank>
	...
	public void printTank(double t, Substance substance)
		...
		System.out.println("QuantitÈ de " + substance.getName() + " : " + equaDiff(t, substance));		System.out.println();
		}
	...
	public void delete()
		{
		//si il se dÈverse dans un tank il s'enlève de la liste de parent de ce dernier
		if (tankChild != null)
			{
