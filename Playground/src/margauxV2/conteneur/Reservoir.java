...
public class Reservoir
	...
	public Reservoir(boolean infini, double capacite, double debit)
		{
		mapSubstance = new  HashMap<Substance,Double>();
		mapLiquide = new HashMap<Substance,Double>();
		listReservoirParent = new ArrayList<Reservoir>();
	...
	public boolean addReservoirParent(Reservoir reservoirParent)
	{
	...
	private void init()
		{
			...
			for(Reservoir reservoir : listReservoirParent)
			{
	...
	private List<Reservoir> listReservoirParent;
